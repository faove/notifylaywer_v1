...
<html lang="en">
  <head>
    ...
    <link rel="icon" href="img/favicons/lawyer-32-253311.png" sizes="32x32" type="image/png">
    <link rel="icon" href="img/favicons/lawyer-16-253311.png" sizes="16x16" type="image/png">
...
<header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
  <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3" href="#">NotifyLaywer</a>
